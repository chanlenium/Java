...
//You might be able to define the same static method (with the same name and signature) in the sub class,
//but that's not overriding. => function을 shadow 하는 것임

//And that's because static methods stick to the class which they are defined in;
//that's again why you would not be able to put "@Override" annotation before their method declaration in the sub class.
